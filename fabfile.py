...
def staging():
    projectname = 'community_choosefi_site'
    basepath = '/srv/community_choosefi_site.brueck.io/%s'
...
def production():
    projectname = 'community_choosefi_site'
    basepath = '/home/community_choosefi_site/%s'
    env.hosts = ['community_choosefi_site@server.community.choosefi.com']
    env.path = basepath % projectname
    env.virtualenv_path = basepath % (projectname + 'env')
    env.push_branch = 'master'
    env.push_remote = 'origin'
    env.after_deploy_url = 'http://community.choosefi.com'
    env.reload_cmd = 'supervisorctl restart {0}'.format(projectname)
